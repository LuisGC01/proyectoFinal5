...
public class MagnitudArregloDTO {
	...
	public MagnitudArregloDTO() {
		// TODO Auto-generated constructor stub
	}

	public MagnitudArregloDTO(Integer idMagnitudArreglo, String magnitud, String unidad, String definicion,
	...
	public String toString() {
		return "MagnitudArregloDTO [idMagnitudArreglo=" + idMagnitudArreglo + ", magnitud=" + magnitud + ", unidad="
				+ unidad + ", definicion=" + definicion + ", capturar=" + capturar + ", repetir=" + repetir
				+ ", asociado=" + asociado + ", idModeloMatematico=" + idModeloMatematico + "]";
	}
